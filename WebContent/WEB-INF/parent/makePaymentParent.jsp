...
<div id="page">
    ...
    <div id="main">
        <div class="page">
            ...
            <p style="color:#ff0000;">Classes are subject to cancellation if minimum enrollment is not met. If a class is cancelled, alternative camp options or a full refund will be provided</p>
            <p>This page serves as a convenient list of all pending payments for all of your campers.</p>
            <div class="section">
                <c:forEach items="${students}" var="student">
                    <h2>${student.getName()}'s <small>Approved Camps</small></h2>
                    <c:choose>
                        <c:when test="${studentsAcceptedUnpaidCamps.get(student.getStudentID()).isEmpty()}">
                            <p>No unpaid camps.</p>
                        </c:when>
                        <c:otherwise>
                            <div class="table-responsive">
                                ...
                                <table id="applied-camps" class="table">
                                    ...
                                    <tbody>
                                    <c:forEach items="${studentsAcceptedUnpaidCamps.get(student.getStudentID())}"
                                               var="camp">
                                        <tr id="${camp.getStudentCampID()}">
                                            ...
                                            <td class="align-middle">$${camp.getCost() / 100}</td>
