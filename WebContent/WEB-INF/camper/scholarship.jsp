...
<%--					</div>--%>
					...
					<p class="changes-note">Note: Changes you make on this page will not be saved until you click <i>Apply for Scholarship</i>. If you wish to unapply for a scholarship, please contact cscamps@usc.edu.</p>
